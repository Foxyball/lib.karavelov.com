<nav class="navbar navbar-default top-navbar" role="navigation">
    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <li><a class="" href="{{ route('admin.logout') }}" data-activates="dropdown1"><b>Изход</b></a></li>
    </ul>
</nav>
<!-- Dropdown Structure -->
...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a class="active-menu waves-effect waves-dark" href="{{ url('/') }}"><i
            ...
            @if (Auth::user()->role == 'admin')
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="{{ route('add.book') }}"><i class="fa-solid fa-plus"></i>Добавяне</a>
                        </li>
                        <li>
                            <a href="{{ route('all.book') }}"><i class="fa-solid fa-bars"></i>Менажиране</a>
                        </li>
                    </ul>
                </li>
            @endif
