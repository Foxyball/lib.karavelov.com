...
@section('content')
    ...
    <form id="myForm" action="{{ route('update.order') }}" method="POST">
        @csrf
        ...
        <div class="form-group">
            ...
            <select name="status" id="inputStatus" class="form-control">
                <option value="0"@if ($order->status == '0') selected @endif>За връщане</option>
                <option value="1" @if($order->status=='1') selected @endif>Изпълнена</option>
            </select>
            ...
            <div class="form-group">
                ...
                <input type="date" name="date_end" value="{{ $order->date_end }}" id="datepicker" class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select name="book_1_id" id="inputBook1" class="form-control">
                        ...
                        @foreach ($books as $book)
                            <option value="{{ $book->id }}" @if ($order->book_1_id == $book->id) selected @endif>
                                {{ $book->book }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="book_2_id" id="inputBook2" class="form-control">
                        ...
                        @foreach ($books as $book)
                            <option value="{{ $book->id }}" @if ($order->book_2_id == $book->id) selected @endif>
                                {{ $book->book }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="book_3_id" id="inputBook3" class="form-control">
                        ...
                        @foreach ($books as $book)
                            <option value="{{ $book->id }}" @if ($order->book_3_id == $book->id) selected @endif>
                                {{ $book->book }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="book_4_id" id="inputBook4" class="form-control">
                        ...
                        @foreach ($books as $book)
                            <option value="{{ $book->id }}" @if ($order->book_4_id == $book->id) selected @endif>
                                {{ $book->book }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="book_5_id" id="inputBook5" class="form-control">
                        ...
                        @foreach ($books as $book)
                            <option value="{{ $book->id }}" @if ($order->book_5_id == $book->id) selected @endif>
                                {{ $book->book }}</option>
                        @endforeach
                    </select>
                </div>
